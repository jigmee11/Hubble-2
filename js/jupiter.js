...
let saad = new Image();
saad.src = "../zurag/shuurga.png";
let saad2 = new Image();
saad2.src = "../zurag/Group 97.png";
let spacex = new Image();
spacex.src = "../zurag/ufog.png";
let guideguul = new Image();
guideguul.src = "../zurag/mountain-hoyr.png";
let spacey = new Image();
spacey.src = "../zurag/puuj.png";
let gal = new Image();
gal.src = "../zurag/qq.png";
let background = new Image();
background.src = "../zurag/jup.png";
...
const start = setInterval(() => {
    if (unasaneseh === true) {
        ...
        if (guih + 60 >= sx && guih <= sx + 10 && uy + 70 >= anhniiuy && uy <= anhniiuy + 60) {
            clearInterval(start)
            window.location.href = "../html/uheh2.html";
        }
            ...
            const niseh = setInterval(() => {
                ...
                if (guih >= cs.width - 80) {
                    ...
                    const huuruh = setInterval(() => {
                        ...
                        gg();
                        if (l <= -120) {
                            window.location.href = "space-shooterjupiter.html";
                        }
                    }, 30);
                }
            }, 30);
